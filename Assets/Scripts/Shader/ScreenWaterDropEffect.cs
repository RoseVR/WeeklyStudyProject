...
public class ScreenWaterDropEffect : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("ScreenWaterDropTex.name = " + ScreenWaterDropTex.name);

        //找到当前的Shader文件
        CurShader = Shader.Find("Unlit/水屏幕");
    ...
    void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        ...
        if (CurShader != null)
        {
            ...
            material.SetFloat("_XSize", SizeX);
            material.SetFloat("_YSize", SizeY);
            material.SetFloat("_DropSpeed", DropSpeed);
            material.SetTexture("_ScreenWarterTex", ScreenWaterDropTex);
